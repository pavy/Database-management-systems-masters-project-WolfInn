...
public class WolfInn {
	...
	private static void generateReport(Statement statement, Connection connection) {
		...
		System.out
				.println("6 - Information on all staff members serving the customer during the stay");
		System.out
				.println("7 - Revenue earned by a hotel during a given date range");
		...
		case 8: mainMenu(statement, connection);
		...
		if(!nextChoice.equals("Y")||!nextChoice.equals("y"))
	...
	private static void mainMenu(Statement statement, Connection connection) {
		try {
			...
			System.out
					.println("Please select the Task or Operation you would like to perform: ");
			System.out.println("-------------------------\n");
